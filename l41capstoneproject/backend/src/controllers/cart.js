...
export const getAddCart = responseHandler(async (req, res, next) => {

    let { restaurant_name, category, quantity, food_id } = req.body;
    let id = food_id;
    quantity = +quantity;
...
export const getCartItemIncrease = responseHandler(async (req, res, next) => {
    const { id } = req.params;
...
export const getCartItemDecrease = responseHandler(async (req, res, next) => {
    const { id } = req.params;
    let { restaurant_name, category } = req.query;
...
export const getCartItemDelete = responseHandler(async (req, res, next) => {
    const { id } = req.params;
    let { restaurant_name, category } = req.query;
...
export const getCartItems = responseHandler(async (req, res, next) => {
